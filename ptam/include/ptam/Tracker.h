...
public:
  ...
  void TrackFrame(CVD::Image<CVD::byte> &imFrame, bool bDraw, const ros::Time& stamp);
  void TrackFrame(CVD::Image<CVD::byte> &imFrame, bool bDraw, const TooN::SO3<double> & imuOrientation, const ros::Time& stamp);
